  ...
  return (
    <main className="dot-bg min-h-screen p-4 pb-16">
      ...
      <div className="max-w-xl mx-auto space-y-4">
        ...
        {/* ── Share link box ──────────────────────────────── */}
        <div className="fade-up fade-up-2 card px-4 py-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 label-tag py-2.5 rounded-xl transition-all duration-150"
              style={{
            ...
            <a
              ...
              className="flex-1 label-tag py-2.5 rounded-xl flex items-center justify-center gap-1.5 transition-all duration-150"
